            ...
            <div className="content">
                <div className="top">
                    ...
                    <div className="media-icons">
                        <a href="https://www.facebook.com/RedWolfInfoTech" target='main'><i className="fab fa-facebook-f"></i></a>
                        <a href="https://www.instagram.com/redwolfinfotech/" target='main'><i className="fab fa-instagram"></i></a>
                        <a href="https://www.linkedin.com/company/red-wolf-info-tech/" target='main'><i className="fab fa-linkedin-in"></i></a>
                        <a href="https://youtube.com/@redwolfinfotech?si=vSizTzX1W4TNOih0" target='main'><i className="fab fa-youtube"></i></a>
                    </div>
                </div>
